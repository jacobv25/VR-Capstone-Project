...
public class CustomAmbientAudioPlayer : MonoBehaviour
{
    public AudioClip firstClip;
    public AudioClip secondClip;
    public AudioSource audioSource1;
    public AudioSource audioSource2;
    public float timeBetweenClips = 12f;
    ...
    private IEnumerator PlayAudioClips()
    {
        ...
        yield return new WaitForSeconds(timeBetweenClips); // Wait for 12 seconds before playing the second clip
